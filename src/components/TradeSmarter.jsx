  ...
  return (
    <section className="py-20 px-6 bg-gradient-to-b from-black-900 to-gray-900">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <button onClick={handleClick} className="cursor-pointer self-start bg-blue-700 text-white text-sm mt-4 font-medium py-3 px-4 rounded-xl shadow-md hover:bg-blue-800 hover:scale-105 transition duration-200">
          Let's get started
        </button>
